...
import linkContentStyles from "./linkContentByNeema.module.css";

const LinkContentByNeema = () => {
  return (
    <div className={linkContentStyles.first}>
      <section className={linkContentStyles.intro}>
        <div className={linkContentStyles.inner}>
          <div className={linkContentStyles.content}>
            <h1>IEEE LINK</h1>
            <a className={linkContentStyles.btn} href="#">View Works</a>
          </div>

        </div>

      </section>
      <section className={linkContentStyles.container} id="start">
        <div className={linkContentStyles.para}>
          <h2>IEEE LINK</h2>
          <p>
            <span> Colloquium Phase 1</span><br />
            Date: 30th April - 9th May, 2020<br />
            No. of Participants: 300+<br />
        ...
        <div className={linkContentStyles.para}>
          <p>
            <span>WIE Learn</span><br />
            Date:5th April-23rd October,2020.<br />
            No.of Participants:125<br />
            ...
            program is open for all registered students.WiE Learn provides two main domains:<br />
            1.Android App development using Android Studio.<br />
            2.Full Stack RaspberryPi<br />
            ...
            Travancore Hub.
            Among them 17 teams areattending Android Development and 8 teams are attending RaspberryPi course.Each team
        ...
        <div className={linkContentStyles.para}>
          <p>
            <span>Venus–The Epitome of WiEness</span><br />
            Date: March 7-13,2020<br />
            No.of Participants: Various SBs and IEEE Sub sections<br />
...
export default  LinkContentByNeema;